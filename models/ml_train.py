...
def train_and_predict(clf, dm_reduction, X_train, y_train, X_calibrate, y_calibrate, X_test, y_test, cv_sets,
...
def find_best_classifier(classifiers, dm_reductions, scorer, X_train, y_train, X_calibrate, y_calibrate, X_test, y_test,
                         cv_sets, params, jobs,
                         args):
    """ 调参，找到最佳分类器(包括降维方法) """
